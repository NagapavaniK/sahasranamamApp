...
import com.devotion.sahasranamam.R
import java.io.IOException
import java.io.InputStream

class adithyaActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        layoutInflater.inflate(R.layout.activity_adithya,findViewById(R.id.container))
        val title=getString(R.string.adithya_name)
        ...
        try {
            myInputStream = assets.open("AdithyaHrudayam.txt")
