...
class ChalisaActivity : BaseActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        layoutInflater.inflate(R.layout.activity_chalisa, findViewById(R.id.container))

        // Set the toolbar title
        val title = getString(R.string.hanuman_chalisa)
        ...
        try {
            myInputStream = assets.open("Hanumanchalisa.txt")
